...
const SecretaryDashboard = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    Promise.all([
      axios.get(`https://2ise-groupe.com/api/students/list?school_year=${schoolYear}`, { headers }), // étudiants de l'année sélectionnée
      axios.get(`https://2ise-groupe.com/api/classes/list?school_year=${schoolYear}`, { headers }),
      axios.get(`https://2ise-groupe.com/api/payments?school_year=${schoolYear}`, { headers }),
      axios.get(`https://2ise-groupe.com/api/events/all?school_year=${schoolYear}`, { headers }),
    ]).then(([studentsRes, classesRes, paymentsRes, eventsRes]) => {
